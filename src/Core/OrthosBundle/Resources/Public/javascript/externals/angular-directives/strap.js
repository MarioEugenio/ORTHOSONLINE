...
angular.module('$strap.directives')
    ...
    .directive('bsTypeahead', ['$parse', function($parse, $timeout) {
    'use strict';
        ...
        link: function postLink(scope, element, attrs, controller) {
            ...
            element.typeahead({
                ...
                updater: function(value) {
                    ...
                    var id = element.attr('typeaheadId');

                    angular.forEach(scope.typeahead, function (data) {

                        if (data.value == value) {
                            scope.tmpAutocomplete[id] = data.id;
                        }
                    });
