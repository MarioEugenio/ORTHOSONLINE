var Grid = {
    ...
    gridPagination: function (component)
    {
            ...
            "bootstrap": {
                "fnInit": function( oSettings, nPaging, fnDraw ) {
                    ...
                    $(nPaging).addClass('pagination').append(
                        '<ul>'+
                            '<li class="prev disabled"><a >&larr; '+oLang.sPrevious+'</a></li>'+
                            '<li class="next disabled"><a >'+oLang.sNext+' &rarr; </a></li>'+
                            '</ul>'
                    );
                    var els = $('a', nPaging);
        ...
        table.dataTable( {
            ...
            "oLanguage": {
                ...
                "sInfoFiltered": "",
                "sSearch": "<li class='icon-search'></li>",
                "oPaginate": {
                    "sFirst":    "Primeiro",
                    "sPrevious": "Anterior",
                    "sNext":     "Próximo",
    ...
    removeRow: function (componet)
    {
        $(componet + " tbody tr td ."+IcoBootstrap.remove).live('click', function(){
            var oTable = $(componet).dataTable();
    ...
    action: function (element, click, arg) {
        setTimeout(function () {
            e = $(element);
            scope = angular.element(e).scope();
            scope.$apply(function(sc){
                Grid.mainfunc(sc, click, arg);
            });
        },300);
    },
    mainfunc: function  (scope, func, arg){
        scope[func](arg);
    }
}