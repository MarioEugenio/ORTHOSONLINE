...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/ORTHOSONLINE/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/ORTHOSONLINE/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/var/www/ORTHOSONLINE/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    {
        $this->services['bazinga.exposetranslation.controller'] = $instance = new \Bazinga\ExposeTranslationBundle\Controller\Controller($this->get('translator'), $this->get('templating'), $this->get('bazinga.exposetranslation.service.translation_finder'), '/var/www/ORTHOSONLINE/app/cache/dev/bazinga_expose_translation', true, '', array(0 => 'messages'));
    ...
    /**
     * Gets the 'bazinga.exposetranslation.service.translation_finder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Bazinga\ExposeTranslationBundle\Service\TranslationFinder A Bazinga\ExposeTranslationBundle\Service\TranslationFinder instance.
     */
    protected function getBazinga_Exposetranslation_Service_TranslationFinderService()
    {
        return $this->services['bazinga.exposetranslation.service.translation_finder'] = new \Bazinga\ExposeTranslationBundle\Service\TranslationFinder($this->get('kernel'));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/ORTHOSONLINE/app/Resources');
    ...
    /**
     * Gets the 'core.especialidadebusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Core\OrthosBundle\Business\EspecialidadeBusiness A Core\OrthosBundle\Business\EspecialidadeBusiness instance.
     */
    protected function getCore_EspecialidadebusinessService()
    {
        return $this->services['core.especialidadebusiness'] = new \Core\OrthosBundle\Business\EspecialidadeBusiness($this);
    }

    /**
     * Gets the 'core.perfilbusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Core\OrthosBundle\Business\PerfilBusiness A Core\OrthosBundle\Business\PerfilBusiness instance.
     */
    protected function getCore_PerfilbusinessService()
    {
        return $this->services['core.perfilbusiness'] = new \Core\OrthosBundle\Business\PerfilBusiness($this);
    }

    /**
     * Gets the 'core.tabelaprecobusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Core\OrthosBundle\Business\TabelaPrecoBusiness A Core\OrthosBundle\Business\TabelaPrecoBusiness instance.
     */
    protected function getCore_TabelaprecobusinessService()
    {
        return $this->services['core.tabelaprecobusiness'] = new \Core\OrthosBundle\Business\TabelaPrecoBusiness($this);
    }

    /**
     * Gets the 'core_orthos.listener.before_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Core\OrthosBundle\EventListener\BeforeControllerListener A Core\OrthosBundle\EventListener\BeforeControllerListener instance.
     */
    protected function getCoreOrthos_Listener_BeforeControllerService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('core_orthos.listener.before_controller', 'request');
        }

        return $this->services['core_orthos.listener.before_controller'] = $this->scopedServices['request']['core_orthos.listener.before_controller'] = new \Core\OrthosBundle\EventListener\BeforeControllerListener($this->get('security.context'), $this->get('http_kernel'), $this->get('router'), $this);
    }

    /**
     * Gets the 'coremessage.messagebusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Core\MessageBundle\Business\MessageBusiness A Core\MessageBundle\Business\MessageBusiness instance.
     */
    protected function getCoremessage_MessagebusinessService()
    {
        return $this->services['coremessage.messagebusiness'] = new \Core\MessageBundle\Business\MessageBusiness($this);
    }

    /**
     * Gets the 'coremessage.messageusersentbusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Core\MessageBundle\Business\MessageUserSentBusiness A Core\MessageBundle\Business\MessageUserSentBusiness instance.
     */
    protected function getCoremessage_MessageusersentbusinessService()
    {
        return $this->services['coremessage.messageusersentbusiness'] = new \Core\MessageBundle\Business\MessageUserSentBusiness($this);
    }

    /**
     * Gets the 'coreuser.userbusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Core\OrthosBundle\Business\UsuarioBusiness A Core\OrthosBundle\Business\UsuarioBusiness instance.
     */
    protected function getCoreuser_UserbusinessService()
    {
        return $this->services['coreuser.userbusiness'] = new \Core\OrthosBundle\Business\UsuarioBusiness($this);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber($this->get('snowcap_im.mogrify_subscriber'));
        $c->addEventListener(array(0 => 'postPersist'), $this->get('persist.event'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'orthosonline', 'host' => 'localhost', 'port' => 3306, 'user' => 'weborthos', 'password' => 'orthos102030', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager5202ff37b8e57_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager5202ff37b8e57_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/var/www/ORTHOSONLINE/app/cache/dev/jms_diextra/doctrine/EntityManager_5202ff37b8e57.php';

        $a = $this->get('annotation_reader');

        $b = new \Doctrine\Common\Cache\ApcCache();
        $b->setNamespace('sf2orm_default_3c36fccd466f773ec6fe09f4dc06e9ac');

        $c = new \Doctrine\Common\Cache\ApcCache();
        $c->setNamespace('sf2orm_default_3c36fccd466f773ec6fe09f4dc06e9ac');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_3c36fccd466f773ec6fe09f4dc06e9ac');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/var/www/ORTHOSONLINE/src/Orthos/Bundle/AgendaBundle/Entity', 1 => '/var/www/ORTHOSONLINE/src/Orthos/Bundle/MediaBundle/Entity', 2 => '/var/www/ORTHOSONLINE/src/Orthos/Bundle/FinanceiroBundle/Entity', 3 => '/var/www/ORTHOSONLINE/src/Core/OrthosBundle/Entity', 4 => '/var/www/ORTHOSONLINE/src/Core/MessageBundle/Entity', 5 => '/var/www/ORTHOSONLINE/src/Orthos/Bundle/ClinicaBundle/Entity', 6 => '/var/www/ORTHOSONLINE/src/Orthos/Bundle/ProntuarioBundle/Entity', 7 => '/var/www/ORTHOSONLINE/src/Orthos/Bundle/MensagemBundle/Entity', 8 => '/var/www/ORTHOSONLINE/src/Core/DashboardBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Orthos\\Bundle\\AgendaBundle\\Entity');
        $f->addDriver($e, 'Orthos\\Bundle\\MediaBundle\\Entity');
        $f->addDriver($e, 'Orthos\\Bundle\\FinanceiroBundle\\Entity');
        $f->addDriver($e, 'Core\\OrthosBundle\\Entity');
        $f->addDriver($e, 'Core\\MessageBundle\\Entity');
        $f->addDriver($e, 'Orthos\\Bundle\\ClinicaBundle\\Entity');
        $f->addDriver($e, 'Orthos\\Bundle\\ProntuarioBundle\\Entity');
        $f->addDriver($e, 'Orthos\\Bundle\\MensagemBundle\\Entity');
        $f->addDriver($e, 'Core\\DashboardBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('OrthosAgendaBundle' => 'Orthos\\Bundle\\AgendaBundle\\Entity', 'OrthosMediaBundle' => 'Orthos\\Bundle\\MediaBundle\\Entity', 'OrthosFinanceiroBundle' => 'Orthos\\Bundle\\FinanceiroBundle\\Entity', 'CoreOrthosBundle' => 'Core\\OrthosBundle\\Entity', 'CoreMessageBundle' => 'Core\\MessageBundle\\Entity', 'OrthosClinicaBundle' => 'Orthos\\Bundle\\ClinicaBundle\\Entity', 'OrthosProntuarioBundle' => 'Orthos\\Bundle\\ProntuarioBundle\\Entity', 'OrthosMensagemBundle' => 'Orthos\\Bundle\\MensagemBundle\\Entity', 'CoreDashboardBundle' => 'Core\\DashboardBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('/var/www/ORTHOSONLINE/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager5202ff37b8e57_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($h, $this);
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.controller', array(0 => 'core_orthos.listener.before_controller', 1 => 'onKernelController'), 0);
        $instance->addListenerService('kernel.controller', array(0 => 'persist.event', 1 => 'onKernelController'), 0);
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/ORTHOSONLINE/app/Resources');
    }
    ...
    {
        return $this->services['fos_js_routing.controller'] = new \FOS\JsRoutingBundle\Controller\Controller(new \Symfony\Component\Serializer\Serializer(array(0 => new \Symfony\Component\Serializer\Normalizer\GetSetMethodNormalizer()), array('json' => new \Symfony\Component\Serializer\Encoder\JsonEncoder())), $this->get('fos_js_routing.extractor'), '/var/www/ORTHOSONLINE/app/cache/dev', true);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/var/www/ORTHOSONLINE/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/ORTHOSONLINE/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'orthos.agendabusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\AgendaBundle\Business\AgendaBusiness A Orthos\Bundle\AgendaBundle\Business\AgendaBusiness instance.
     */
    protected function getOrthos_AgendabusinessService()
    {
        return $this->services['orthos.agendabusiness'] = new \Orthos\Bundle\AgendaBundle\Business\AgendaBusiness($this);
    }

    /**
     * Gets the 'orthos.bancobusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\ClinicaBundle\Business\BancoBusiness A Orthos\Bundle\ClinicaBundle\Business\BancoBusiness instance.
     */
    protected function getOrthos_BancobusinessService()
    {
        return $this->services['orthos.bancobusiness'] = new \Orthos\Bundle\ClinicaBundle\Business\BancoBusiness($this);
    }

    /**
     * Gets the 'orthos.cadeirabusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\ClinicaBundle\Business\CadeiraBusiness A Orthos\Bundle\ClinicaBundle\Business\CadeiraBusiness instance.
     */
    protected function getOrthos_CadeirabusinessService()
    {
        return $this->services['orthos.cadeirabusiness'] = new \Orthos\Bundle\ClinicaBundle\Business\CadeiraBusiness($this);
    }

    /**
     * Gets the 'orthos.clinicabusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\ClinicaBundle\Business\ClinicaBusiness A Orthos\Bundle\ClinicaBundle\Business\ClinicaBusiness instance.
     */
    protected function getOrthos_ClinicabusinessService()
    {
        return $this->services['orthos.clinicabusiness'] = new \Orthos\Bundle\ClinicaBundle\Business\ClinicaBusiness($this);
    }

    /**
     * Gets the 'orthos.consultabusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\AgendaBundle\Business\ConsultaBusiness A Orthos\Bundle\AgendaBundle\Business\ConsultaBusiness instance.
     */
    protected function getOrthos_ConsultabusinessService()
    {
        return $this->services['orthos.consultabusiness'] = new \Orthos\Bundle\AgendaBundle\Business\ConsultaBusiness($this);
    }

    /**
     * Gets the 'orthos.conveniobusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\ClinicaBundle\Business\ConvenioBusiness A Orthos\Bundle\ClinicaBundle\Business\ConvenioBusiness instance.
     */
    protected function getOrthos_ConveniobusinessService()
    {
        return $this->services['orthos.conveniobusiness'] = new \Orthos\Bundle\ClinicaBundle\Business\ConvenioBusiness($this);
    }

    /**
     * Gets the 'orthos.financeirobusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\FinanceiroBundle\Business\FinanceiroBusiness A Orthos\Bundle\FinanceiroBundle\Business\FinanceiroBusiness instance.
     */
    protected function getOrthos_FinanceirobusinessService()
    {
        return $this->services['orthos.financeirobusiness'] = new \Orthos\Bundle\FinanceiroBundle\Business\FinanceiroBusiness($this);
    }

    /**
     * Gets the 'orthos.fornecedorbusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\FinanceiroBundle\Business\FornecedorBusiness A Orthos\Bundle\FinanceiroBundle\Business\FornecedorBusiness instance.
     */
    protected function getOrthos_FornecedorbusinessService()
    {
        return $this->services['orthos.fornecedorbusiness'] = new \Orthos\Bundle\FinanceiroBundle\Business\FornecedorBusiness($this);
    }

    /**
     * Gets the 'orthos.lancamentosbusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\FinanceiroBundle\Business\LancamentosBusiness A Orthos\Bundle\FinanceiroBundle\Business\LancamentosBusiness instance.
     */
    protected function getOrthos_LancamentosbusinessService()
    {
        return $this->services['orthos.lancamentosbusiness'] = new \Orthos\Bundle\FinanceiroBundle\Business\LancamentosBusiness($this);
    }

    /**
     * Gets the 'orthos.lancamentoscategoriabusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\FinanceiroBundle\Business\LancamentosCategoriaBusiness A Orthos\Bundle\FinanceiroBundle\Business\LancamentosCategoriaBusiness instance.
     */
    protected function getOrthos_LancamentoscategoriabusinessService()
    {
        return $this->services['orthos.lancamentoscategoriabusiness'] = new \Orthos\Bundle\FinanceiroBundle\Business\LancamentosCategoriaBusiness($this);
    }

    /**
     * Gets the 'orthos.mediabusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\MediaBundle\Business\ImagemBusiness A Orthos\Bundle\MediaBundle\Business\ImagemBusiness instance.
     */
    protected function getOrthos_MediabusinessService()
    {
        return $this->services['orthos.mediabusiness'] = new \Orthos\Bundle\MediaBundle\Business\ImagemBusiness($this);
    }

    /**
     * Gets the 'orthos.mensagembusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\MensagemBundle\Business\MensagemBusiness A Orthos\Bundle\MensagemBundle\Business\MensagemBusiness instance.
     */
    protected function getOrthos_MensagembusinessService()
    {
        return $this->services['orthos.mensagembusiness'] = new \Orthos\Bundle\MensagemBundle\Business\MensagemBusiness($this);
    }

    /**
     * Gets the 'orthos.pacientebusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\PacienteBundle\Business\PacienteBusiness A Orthos\Bundle\PacienteBundle\Business\PacienteBusiness instance.
     */
    protected function getOrthos_PacientebusinessService()
    {
        return $this->services['orthos.pacientebusiness'] = new \Orthos\Bundle\PacienteBundle\Business\PacienteBusiness($this);
    }

    /**
     * Gets the 'orthos.pacientestatusbusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\ClinicaBundle\Business\PacienteStatusBusiness A Orthos\Bundle\ClinicaBundle\Business\PacienteStatusBusiness instance.
     */
    protected function getOrthos_PacientestatusbusinessService()
    {
        return $this->services['orthos.pacientestatusbusiness'] = new \Orthos\Bundle\ClinicaBundle\Business\PacienteStatusBusiness($this);
    }

    /**
     * Gets the 'orthos.parcelasbusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\FinanceiroBundle\Business\ParcelasBusiness A Orthos\Bundle\FinanceiroBundle\Business\ParcelasBusiness instance.
     */
    protected function getOrthos_ParcelasbusinessService()
    {
        return $this->services['orthos.parcelasbusiness'] = new \Orthos\Bundle\FinanceiroBundle\Business\ParcelasBusiness($this);
    }

    /**
     * Gets the 'orthos.procedimentoarealizarbusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\ProntuarioBundle\Business\ProcedimentoArealizarBusiness A Orthos\Bundle\ProntuarioBundle\Business\ProcedimentoArealizarBusiness instance.
     */
    protected function getOrthos_ProcedimentoarealizarbusinessService()
    {
        return $this->services['orthos.procedimentoarealizarbusiness'] = new \Orthos\Bundle\ProntuarioBundle\Business\ProcedimentoArealizarBusiness($this);
    }

    /**
     * Gets the 'orthos.procedimentobusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\ProntuarioBundle\Business\ProcedimentoBusiness A Orthos\Bundle\ProntuarioBundle\Business\ProcedimentoBusiness instance.
     */
    protected function getOrthos_ProcedimentobusinessService()
    {
        return $this->services['orthos.procedimentobusiness'] = new \Orthos\Bundle\ProntuarioBundle\Business\ProcedimentoBusiness($this);
    }

    /**
     * Gets the 'orthos.procedimentorealizadosbusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\ProntuarioBundle\Business\ProcedimentoRealizadosBusiness A Orthos\Bundle\ProntuarioBundle\Business\ProcedimentoRealizadosBusiness instance.
     */
    protected function getOrthos_ProcedimentorealizadosbusinessService()
    {
        return $this->services['orthos.procedimentorealizadosbusiness'] = new \Orthos\Bundle\ProntuarioBundle\Business\ProcedimentoRealizadosBusiness($this);
    }

    /**
     * Gets the 'orthos.prontuariobusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\ProntuarioBundle\Business\ProntuarioBusiness A Orthos\Bundle\ProntuarioBundle\Business\ProntuarioBusiness instance.
     */
    protected function getOrthos_ProntuariobusinessService()
    {
        return $this->services['orthos.prontuariobusiness'] = new \Orthos\Bundle\ProntuarioBundle\Business\ProntuarioBusiness($this);
    }

    /**
     * Gets the 'orthos.statusbusiness' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orthos\Bundle\AgendaBundle\Business\StatusBusiness A Orthos\Bundle\AgendaBundle\Business\StatusBusiness instance.
     */
    protected function getOrthos_StatusbusinessService()
    {
        return $this->services['orthos.statusbusiness'] = new \Orthos\Bundle\AgendaBundle\Business\StatusBusiness($this);
    }

    /**
     * Gets the 'persist.event' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Core\OrthosBundle\EventListener\EntityListern A Core\OrthosBundle\EventListener\EntityListern instance.
     */
    protected function getPersist_EventService()
    {
        return $this->services['persist.event'] = new \Core\OrthosBundle\EventListener\EntityListern($this->get('http_kernel'), $this->get('router'), $this);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/var/www/ORTHOSONLINE/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['punk_ave.file_uploader_file_manager'] = new \PunkAve\FileUploaderBundle\Services\FileManager(array('file_base_path' => '/var/www/ORTHOSONLINE/app/../web/uploads'));
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/ORTHOSONLINE/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/var/www/ORTHOSONLINE/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Core\\OrthosBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($h, array('login_path' => '/login', 'use_referer' => true, 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path'));
        $j->setProviderKey('secured_area');

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($g, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.main')), 'secured_area', $a, $c), 2 => $i, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $h, 'secured_area', $j, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $h, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false), $a), array('check_path' => '/login_check', 'use_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5202ff37aac65', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $g, $f, $a)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $h, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $h, '/login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/ORTHOSONLINE/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/www/ORTHOSONLINE/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/ORTHOSONLINE/app/cache/dev/sessions');
    }
    ...
    /**
     * Gets the 'snowcap_im.form_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Snowcap\ImBundle\Form\Extension\ImageTypeExtension A Snowcap\ImBundle\Form\Extension\ImageTypeExtension instance.
     */
    protected function getSnowcapIm_FormExtensionService()
    {
        return $this->services['snowcap_im.form_extension'] = new \Snowcap\ImBundle\Form\Extension\ImageTypeExtension($this->get('snowcap_im.manager'));
    }

    /**
     * Gets the 'snowcap_im.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Snowcap\ImBundle\Manager A Snowcap\ImBundle\Manager instance.
     */
    protected function getSnowcapIm_ManagerService()
    {
        return $this->services['snowcap_im.manager'] = new \Snowcap\ImBundle\Manager($this->get('snowcap_im.wrapper'), $this->get('kernel'), array('small' => array('resize' => '50x', 'quality' => 80), 'medium' => array('thumbnail' => '100x100>'), 'square' => array('resize' => '100x100^', 'gravity' => 'center', 'crop' => '100x100+0+0')));
    }

    /**
     * Gets the 'snowcap_im.mogrify_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Snowcap\ImBundle\Listener\MogrifySubscriber A Snowcap\ImBundle\Listener\MogrifySubscriber instance.
     */
    protected function getSnowcapIm_MogrifySubscriberService()
    {
        return $this->services['snowcap_im.mogrify_subscriber'] = new \Snowcap\ImBundle\Listener\MogrifySubscriber('/var/www/ORTHOSONLINE/app', $this->get('snowcap_im.manager'));
    }

    /**
     * Gets the 'snowcap_im.twig' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Snowcap\ImBundle\Twig\Extension\ImExtension A Snowcap\ImBundle\Twig\Extension\ImExtension instance.
     */
    protected function getSnowcapIm_TwigService()
    {
        return $this->services['snowcap_im.twig'] = new \Snowcap\ImBundle\Twig\Extension\ImExtension($this);
    }

    /**
     * Gets the 'snowcap_im.wrapper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Snowcap\ImBundle\Wrapper A Snowcap\ImBundle\Wrapper instance.
     */
    protected function getSnowcapIm_WrapperService()
    {
        return $this->services['snowcap_im.wrapper'] = new \Snowcap\ImBundle\Wrapper('\\Symfony\\Component\\Process\\Process', '/opt/local/bin/');
    }
    ...
    protected function getSwiftmailer_Transport_RealService()
    {
        ...
        $instance->setUsername('mario.eugenio@gmail.com');
        $instance->setPassword('mario@1985');
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/ORTHOSONLINE/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/var/www/ORTHOSONLINE/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/var/www/ORTHOSONLINE/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension($this->get('snowcap_im.twig'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/ORTHOSONLINE/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
     ...
     *
     * @return EntityManager5202ff37b8e57_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/ORTHOSONLINE/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/var/www/ORTHOSONLINE/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/var/www/ORTHOSONLINE/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Core\\OrthosBundle\\Entity\\Usuario', 'sq_usuario', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/ORTHOSONLINE/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/var/www/ORTHOSONLINE/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/ORTHOSONLINE/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/ORTHOSONLINE/app/cache/dev',
            'kernel.logs_dir' => '/var/www/ORTHOSONLINE/app/logs',
            'kernel.bundles' => array(
                ...
                'PortalPortalBundle' => 'Portal\\Bundle\\PortalBundle\\PortalPortalBundle',
                'OrthosAgendaBundle' => 'Orthos\\Bundle\\AgendaBundle\\OrthosAgendaBundle',
                'OrthosPacienteBundle' => 'Orthos\\Bundle\\PacienteBundle\\OrthosPacienteBundle',
                'OrthosMediaBundle' => 'Orthos\\Bundle\\MediaBundle\\OrthosMediaBundle',
                'OrthosFinanceiroBundle' => 'Orthos\\Bundle\\FinanceiroBundle\\OrthosFinanceiroBundle',
                'OrthosRelatoriosBundle' => 'Orthos\\Bundle\\RelatoriosBundle\\OrthosRelatoriosBundle',
                'CoreOrthosBundle' => 'Core\\OrthosBundle\\CoreOrthosBundle',
                'CoreMessageBundle' => 'Core\\MessageBundle\\CoreMessageBundle',
                'OrthosClinicaBundle' => 'Orthos\\Bundle\\ClinicaBundle\\OrthosClinicaBundle',
                'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle',
                'BazingaExposeTranslationBundle' => 'Bazinga\\ExposeTranslationBundle\\BazingaExposeTranslationBundle',
                'OrthosProntuarioBundle' => 'Orthos\\Bundle\\ProntuarioBundle\\OrthosProntuarioBundle',
                'SnowcapImBundle' => 'Snowcap\\ImBundle\\SnowcapImBundle',
                'PunkAveFileUploaderBundle' => 'PunkAve\\FileUploaderBundle\\PunkAveFileUploaderBundle',
                'OrthosMensagemBundle' => 'Orthos\\Bundle\\MensagemBundle\\OrthosMensagemBundle',
                'CoreDashboardBundle' => 'Core\\DashboardBundle\\CoreDashboardBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'orthosonline',
            'database_user' => 'weborthos',
            'database_password' => 'orthos102030',
            'mailer_transport' => 'gmail',
            'mailer_host' => NULL,
            'mailer_user' => 'mario.eugenio@gmail.com',
            'mailer_password' => 'mario@1985',
            'locale' => 'en',
            ...
            'debug.container.dump' => '/var/www/ORTHOSONLINE/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/var/www/ORTHOSONLINE/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/var/www/ORTHOSONLINE/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/var/www/ORTHOSONLINE/app/cache/dev/profiler',
            ...
            'router.resource' => '/var/www/ORTHOSONLINE/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/ORTHOSONLINE/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.transport.smtp.username' => 'mario.eugenio@gmail.com',
            'swiftmailer.transport.smtp.password' => 'mario@1985',
            ...
            'swiftmailer.spool.memory.path' => '/var/www/ORTHOSONLINE/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/var/www/ORTHOSONLINE/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/var/www/ORTHOSONLINE/app/../web',
            'assetic.write_to' => '/var/www/ORTHOSONLINE/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/ORTHOSONLINE/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/var/www/ORTHOSONLINE/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/var/www/ORTHOSONLINE/app/cache/dev/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/www/ORTHOSONLINE/app/cache/dev/jms_diextra/doctrine/EntityManager_5202ff37b8e57.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5202ff37b8e57_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/var/www/ORTHOSONLINE/app/cache/dev/jms_security',
            ...
            'bazinga.exposetranslation.service.translation_finder.class' => 'Bazinga\\ExposeTranslationBundle\\Service\\TranslationFinder',
            ...
            'file_uploader.file_base_path' => '/var/www/ORTHOSONLINE/app/../web/uploads',
